...
public class Main {
  ...
  public static void main(String... args) {
    Controller.setDatabases(new MockUserDB(), new MockSessionDB());
    ...
    server.routes(() -> {
      ...
      path("teams", () -> {
        ...
        path("registered", () -> {
          ...
          put(UNIMPLEMENTED); // update team info (ADMIN) or update any team's status/info (SUDO)
        });
      });
      path("users", () -> {
        get(UNIMPLEMENTED); // get list of team's users (ADMIN)
        post(UNIMPLEMENTED); // register a new user on team (ADMIN) OR on any team (SUDO)
