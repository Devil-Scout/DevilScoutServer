    ...
    javalin.routes(() -> {
      ...
      path("manage", () -> {
        path("teams", () -> {
          ...
          put(UNIMPLEMENTED); // update team info (ADMIN/SUDO)
        });

        path("users", () -> {
          get(UNIMPLEMENTED); // get team's users (ADMIN)
          get("{team}", UNIMPLEMENTED); // get another team's users (SUDO)
          post(UNIMPLEMENTED); // register new user (ADMIN/SUDO)
          delete(UNIMPLEMENTED); // unregister user (ADMIN/SUDO)
          put(UNIMPLEMENTED); // update user status (ADMIN/SUDO)
        });
      });
    });
  }
